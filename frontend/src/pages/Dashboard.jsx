...
const Dashboard = () => {
    // State for Vehicle Data (from WebSocket)
    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            ...
            // Auto-Trigger Alert if Error Code appears
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (steps.length > 0) {
                addMessage("ai", "RECOMMENDED ACTIONS: \n" + steps.join("\n"));
            }
            if (booking) {
                addMessage("ai", "📅 SERVICE UPDATE: " + booking);
            }
    ...
    // --- NEW FUNCTION: HANDLES THE CALL BUTTON CLICK ---
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        {/* CALL ASSIST BUTTON - UPDATED WITH ONCLICK */}
                        <div
                            onClick={handleCallAssist}
                            className="bg-slate-800 p-4 rounded-lg border border-slate-700 flex flex-col items-center justify-center hover:bg-slate-700 cursor-pointer transition active:scale-95"
                        >
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        {messages.map((msg, idx) => (
                            <div key={idx} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                <div className={`max-w-[80%] p-3 rounded-lg text-sm whitespace-pre-line ${msg.sender === 'user' ? 'bg-blue-600 text-white' :
